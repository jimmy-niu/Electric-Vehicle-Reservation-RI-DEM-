...
io.of('/user').on('connection', function(socket) {
    socket.on('join', function(user, callback){
        conn.query('SELECT *, vehicles.isEV FROM reservations INNER JOIN vehicles ON reservations.license = vehicles.license WHERE user = ? ORDER BY start ASC', [user], function(error, data){
            callback(data);
        });
    });
